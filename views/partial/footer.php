...
<footer class='main-footer dt-sl'>
    <div class='back-to-top'>
        <a href='#'><span class='icon' style="padding: 0;"><i class='mdi mdi-chevron-up'></i></span> <span>بازگشت به بالا</span>
        </a>
    </div>
    ...
    if ($getLastProducts) {
        foreach ($getLastProducts as $product) {
            // pass web-site url
            $site_url  = productUrl($product['tracking_code']);
            // post title
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <a href="https://instagram.com/instagram?url=<?=$site_url?>&text=<?=$site_title?>"
                            ...
                            <a href="https://api.whatsapp.com/send?text=<?php echo $product['title'] ?><?php echo productUrl($product['tracking_code']) ?>"
                            ...
                            <a href="https://t.me/share/url?url=<?php echo productUrl($product['tracking_code']) ?>"
                            ...
                            <a href="https://twitter.com/intent/tweet?url=<?php echo productUrl($product['tracking_code']) ?>"
                            ...
                            <a href="https://www.linkedin.com/sharing/share-offsite/?url=<?php echo productUrl($product['tracking_code']) ?>"
                            ...
                            <a href="https://www.facebook.com/sharer.php?u=<?php echo productUrl($product['tracking_code']) ?>"
                               class="btn text-light" target="_blank" style="background-color: #365899;">
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-3">
                                ...
                                <button onclick="CopyText('<?php echo $product['id'] ?>')"
                                        class="btn btn-light mr-4 shadow w-25" id="" style="border: 1px solid black;">
                                <img class="w-25" src="assets/img/copy.svg" alt="copy">
                                </button>
                            </div>
        ...
        <div class='footer-widgets'>
            <div class='row'>
                <div class='col-12 col-md-6 col-lg-3'>
                    <div class='widget-menu widget card'>
                        <header class='card-header'>
                            <h3 class='card-title'>راهنمای خرید از عنبری تویز</h3>
                        </header>
                ...
                <div class='col-12 col-md-6 col-lg-3'>
                    <div class='widget-menu widget card'>
                        <header class='card-header'>
                            <h3 class='card-title'>با  عنبری تویز</h3>
                        </header>
                        <ul class='footer-menu'>
                            <li>
                                <a href='#'>فروش در  عنبری تویز</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href='#'>تماس با عنبری تویز</a>
                            </li>
                            <li>
                                <a href='about-us.php'>درباره عنبری تویز</a>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class='socials'>
                        ...
                        <div class='footer-social'>
                            <ul class='text-center'>
                                <li><a href='https://instagram.com/_u/anbari_toys'><i class='mdi mdi-instagram'></i></a></li>
