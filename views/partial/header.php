...
<head>
    ...
    ?>
    <title>فروشگاه اسباب بازی Anbari Toys|عنبری تویز</title>
    <!-- Bootstrap -->
    ...
    <link rel='stylesheet' href='/assets/css/anbar-refresh.css?v=15'>
</head>
...
<body>
    ...
    <div class="promo-bar">
        <a href="https://www.instagram.com/anbari_toys?igsh=d2NpOTVqeWFxMjVt" class="promo-bar__link" target="_blank" rel="noopener">
            <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
