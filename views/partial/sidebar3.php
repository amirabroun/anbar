                        ...
                        <div class="card-header" id="headingTwo">
                            <h2 class="mb-0">
                                <button class="btn btn-block text-right collapsed" type="button"
                                    ...
                                    زیر مجموعه <span class="text-info shadow btn font-weight-bold" style="margin-top: -5px;"><?php echo $categori_name_org; ?></span>
                                    <i class="mdi mdi-chevron-down"></i>
                                </button>
                            </h2>
                        </div>
                                    ...
                                    foreach ($categoryzero as $zero){
                                        ...
                                        <a href='<?php echo cagegorystUrl($zero['id'])?>'>
                                            ...
                                            if ($_GET['id'] === $zero['id']){
                                                ...
                                                <div class="custom-control custom-checkbox text-dark mt-1">
                                                    <input class="custom-control-input">
                                                    <label class="custom-control-label"><?php echo $zero['title'] ?></label>
                                                </div>
                                                <?php
                                            }
                                            ?>
