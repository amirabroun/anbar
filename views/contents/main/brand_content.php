...
<main class="main-content dt-sl mt-4 mb-3">
    <div class="container main-container">
        <?php
        if (!isset($_GET['id'])){
            setMessage2('warning','لطفا برندی را انتخاب کنید');
            redirect('products.php');
        }
        $getLastProductsByCategory = getLastProductsByCategoryIsIdBrand($_GET['id']);
        $getLastProducts=getLastProductsByBrand($_GET['id']);
                            ...
                            <div class="row mb-3 mx-0 px-res-0">
                                ...
                                <?php
                                    ...
                                    <div class="warning alert w-25" style="margin: auto;">
                                        <div class="content">
                                             هیج کالای در برند  <span class="text-info"> (&nbsp;<?php echo $categori_name_org ?>&nbsp;) </span> برند وجود ندارد.
                                        </div>
                                        <div class="icon" >
