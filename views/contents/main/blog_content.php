                                    ...
                                    <div class="post-thumbnail">
                                        <a href="single-blogs.php?id=<?= $Articles['id'] ?>">
                                            ...
                                            if (!empty($photoBlog2['name'])){
                                                ?>
                                                <img loading="lazy" decoding="async" src="<?php echo DOMAIN['public'] . $photoBlog2['src'] . $photoBlog2['name']?>" alt="<?php echo $Articles['title'] ?>">
                                                <?php
                                            }else{
                                                ?>
                                                <img loading="lazy" decoding="async" src='<?php echo normalizedPath(DOMAIN['public'],'/images/180.png')?>' alt="تصویر مقالات عنبری تویز">
                                                <?php
                                            }
                                            }else{
                                                ?>
                                    ...
                                    <a href="single-blogs.php?id=<?= $Articles['id'] ?>">
                                        ...
                                        if ($photoBlog){
                                            ...
                                            if (!empty($photoBlog2['name'])){
                                                ...
                                                ?>
                                                <img loading="lazy" decoding="async"  width="50" height="50"  src='<?php echo normalizedPath(DOMAIN['public'],'/images/180.png')?>' alt="جدید ترین مقالات عنبری تویز">
                                                <?php
                                            }
                                        }else{
                                            ?>
