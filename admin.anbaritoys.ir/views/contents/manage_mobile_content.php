        ...
        <div class="container">
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header" >
                    <h3 class="card-title">تلفن ها</h3>
                </div>
                <div class="card-body">
                        ...
                        if ($getCategory ){
                            foreach ($getCategory as $key=> $getcategory){
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $getcategory['mobileTo']?></td>
                                    <td><?php echo $getcategory['mobile_home']?></td>
                                    <td nowrap="nowrap">
                                        <a href="/update_mobile.php?id=<?php echo $getcategory['id'] ?>" class="btn btn-primary btn-icon btn-shadow-hover font-weight-bold mr-2">
