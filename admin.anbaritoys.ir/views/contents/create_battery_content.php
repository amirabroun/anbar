<div class="an-card">
    <div class="an-card-head">
        ...
        <a class="an-btn an-btn-ghost an-btn-sm" href="manage_battery.php">
    ...
    <div class="an-card-body">
        ...
        <form method="post" novalidate>
            <input type="hidden" name="action" value="create_battery">
            <div class="an-form-grid">
                <div class="an-field">
                    <label>ظرفیت باتری <small>*</small></label>
                    <input type="text" class="an-input" name="title" placeholder="مثلاً 3000">
                </div>
            </div>
            <div class="an-form-actions" style="margin-top:22px">
                ...
                <a class="an-btn an-btn-ghost" href="manage_battery.php">انصراف</a>
            </div>
        </form>
    </div>
</div>
