<div class="an-card">
    <div class="an-card-head">
        ...
        <a class="an-btn an-btn-ghost an-btn-sm" href="manage_memory.php">
    ...
    <div class="an-card-body">
        ...
        <form method="post" novalidate>
            ...
            <div class="an-form-grid">
                <div class="an-field">
                    <label>حجم (عدد) <small>*</small></label>
                    <input type="text" class="an-input" name="title" placeholder="مثلاً 64">
                </div>
            </div>
            <div class="an-form-actions" style="margin-top:22px">
                ...
                <a class="an-btn an-btn-ghost" href="manage_memory.php">انصراف</a>
            </div>
        </form>
    </div>
</div>
