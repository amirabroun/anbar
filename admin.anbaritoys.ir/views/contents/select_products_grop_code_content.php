...
<div class="an-card">
    <div class="an-toolbar">
        ...
        <a class="an-btn an-btn-ghost an-btn-sm" href="manage_discount_code_grop.php" style="margin-right:14px">
            ...
            if ($getProduct) {
                foreach ($getProduct as $key => $getproduct) {
                    ...
                    <tr>
                        ...
                        <td>
                            <form method="post">
                                <input type="hidden" name="change_product_dic_code_on_nnn" value="<?php echo $anCodeId ?>">
                                <?php if (selectcheckinPRODUCTcode2($anCodeId, (int)$getproduct['id'])) { ?>
