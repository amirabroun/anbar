<?php
$getCode = selectcode_userTBL();
?>
<div class="an-card">
    <div class="an-toolbar">
        <div class="an-search">
            <svg class="an-ic"><use href="#an-i-search"></use></svg>
            <input type="text" placeholder="جستجو در کدهای کاربری…">
        </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="an-actions">
                                <a class="an-iconbtn is-trash" href="?action=discount_code_user&code_id=<?php echo $codeId ?>" title="حذف کد">
                                    <svg class="an-ic"><use href="#an-i-trash"></use></svg>
                                </a>
                                <a class="an-btn an-btn-ghost an-btn-sm" href="select_user_code.php?category_id=<?php echo $codeId ?>" title="انتخاب کاربران قابل استفاده">
                                    <svg class="an-ic" style="width:15px;height:15px"><use href="#an-i-users"></use></svg>
                                    کاربران مجاز
                                </a>
                                <a class="an-btn an-btn-ghost an-btn-sm" href="select_products_user_code.php?category_id=<?php echo $codeId ?>" title="انتخاب محصولات غیرقابل اعمال">
