<div class="an-card">
    <div class="an-card-head">
        ...
        <a class="an-btn an-btn-ghost an-btn-sm" href="manage_ram.php">
    ...
    <div class="an-card-body">
        ...
        <form method="post" novalidate>
            <input type="hidden" name="action" value="create_ram">
            <div class="an-form-grid">
                <div class="an-field">
                    <label>حجم رم (عدد) <small>*</small></label>
                    <input type="text" class="an-input" name="title" placeholder="مثلاً 8">
                </div>
            </div>
            <div class="an-form-actions" style="margin-top:22px">
                ...
                <a class="an-btn an-btn-ghost" href="manage_ram.php">انصراف</a>
            </div>
        </form>
    </div>
</div>
