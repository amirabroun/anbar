                    ...
                    <tr>
                        ...
                        <td>
                            <div class="an-actions">
                                <a class="an-iconbtn is-edit" href="manage_single_comante.php?massege_id=<?php echo $getcategory['id'] ?>" title="مشاهده جزئیات">
                                    <svg class="an-ic"><use href="#an-i-eye"></use></svg>
                                </a>
                                <a class="an-iconbtn is-bolt" href="?action=change_status_comente&comante_id=<?php echo $getcategory['id'] ?>&old_status=<?php echo $anStatus ?>" title="تایید / عدم تایید">
                                    <svg class="an-ic"><use href="#an-i-bolt"></use></svg>
                                </a>
                                <a class="an-iconbtn is-trash" href="?action=delete_comante&id=<?php echo $getcategory['id'] ?>" title="حذف دیدگاه">
