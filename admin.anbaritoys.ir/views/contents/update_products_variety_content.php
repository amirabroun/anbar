<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            <?php
            $product=selectproductvariety($_GET['product_variety_id']);
            ?>
            <div class="card card-custom gutter-b" ">
                <div class="card-header">
                    <h1 class="card-title"> جزییات محصول
                        <a class="label label-lg font-weight-bold label-light-info label-inline"><?php echo $product['tracking_code'] ?></a>
                    </h1>
                </div>
                <form class="form" id="form_update_product_variety">
                    <input type="hidden" name="product_variety_id" value="<?php echo $_GET['product_variety_id'] ?>">
                    <div class="card-header">
                        <h3 class="card-title">  با مشخصات
                            <a class=""> <?php echo $product['color'] ?></a>
                        </h3>
                    </div>
                    <div class="card-body">
