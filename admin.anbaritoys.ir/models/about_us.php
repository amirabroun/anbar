...
function selectAbout_usStockById ($id){
    global $cn;
    $sql="select * from stock_for_you where id =?";
...
function update_about_stock($stock,$id){
    global $cn;
    $sql="update stock_for_you set stock=? where id=?";
    $result=$cn->prepare($sql);
