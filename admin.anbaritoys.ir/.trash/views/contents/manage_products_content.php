                    ...
                    <div class="card-body">
                        <table class="table table-bordered table-hover table-checkable" id="datatable_products" style="margin-top: 13px !important;">
                            ...
                            <tr>
                                ...
                                <td nowrap="nowrap">
                                    <a href="/update_products.php?products_id=<?php echo $getproduct['id'] ?>" class="btn btn-primary btn-icon btn-shadow-hover font-weight-bold mr-2">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <a href="?action=change_status_products&products_id=<?php echo $getproduct['id']?>&old_status_product=<?php echo $getproduct['status'] ?>" class="btn btn-warning btn-icon btn-shadow-hover font-weight-bold mr-2">
                                        <i class="fa fa-bolt" style='color: white'></i>
                                    </a>
                                    <a href="?action=change_Suggested_products&products_id=<?php echo $getproduct['id']?>&old_Suggested_product=<?php echo $getproduct['Suggested'] ?>" class="btn btn-info btn-icon btn-shadow-hover font-weight-bold mr-2">
                                    ...
                                    <a href="/manage_products_photos.php?product_id=<?php echo $getproduct['id'] ?>" class="btn btn-success btn-icon btn-shadow-hover font-weight-bold mr-2">
                                    ...
                                    <a href="/manage_products_category.php?product_id=<?php echo $getproduct['id'] ?>" class="btn btn-info btn-shadow-hover font-weight-bold mr-2" style="width: 34px" data-toggle="tooltip" data-theme="dark" title="افزودن دسته بندی محصول">
                                        <svg style="margin-right: -5px" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check-square-fill" viewBox="0 0 16 16">
                                            <path d="M2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2zm10.03 4.97a.75.75 0 0 1 .011 1.05l-3.992 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.75.75 0 0 1 1.08-.022z"/>
                                        </svg>
                                    </a>
