                    ...
                    <table class="table table-bordered table-hover table-checkable" id="kt_datatable3"
                        ...
                        foreach ($getPrepre as $key => $prepre){
                            ...
                            <tr>
                                ...
                                <summary style="font-size: 20px;width: 90%">
                                    <span style="overflow: hidden;display: -webkit-box;-webkit-line-clamp: 1;-webkit-box-orient: vertical;white-space: normal;text-overflow: ellipsis;"> <?php echo $prepre['description'];?></span>
                                </summary>
                                    <br>
                                    <?php echo $prepre['description'];?>
                                </details>
