                        ...
                        if ($getCategory ){
                            foreach ($getCategory as $key=> $getcategory){
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $getcategory['question']?></td>
                                    <td nowrap="nowrap">
                                        <a href="/update_about_us_question.php?id=<?php echo $getcategory['id'] ?>" class="btn btn-primary btn-icon btn-shadow-hover font-weight-bold mr-2">
