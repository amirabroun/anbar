                                        ...
                                        <div class="d-flex justify-content-between flex-column flex-md-row font-size-lg">
                                            ...
                                            <div class="d-flex flex-column text-md-right">
                                                ...
                                                if (!empty($getDetailsProductsByID['photo_name'])){
                                                    ?>
                                                    <img  height="120" width="150" src='<?php echo normalizedPath(DOMAIN['public'], $getDetailsProductsByID['photo_src'], $getDetailsProductsByID['photo_name'])?>' alt='Product Thumbnail'>
                                                    <?php
                                                }else{
                                                    ?>
