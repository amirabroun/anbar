<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Page Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">آمورش خرید</h5>
                <!--end::Page Title-->
                <!--begin::Actions-->
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            <?php
            $category=selectQuestionById($_GET['id']);
            ?>
            <div class="card card-custom gutter-b" >
                <div class="card-header">
                    <h3 class="card-title">ویرایش آومورش خرید</h3>
                </div>
                ...
                <form class="form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-12">
                                <label>متن:</label>
                                <textarea type="text" class="summernote" name="title"><?php  echo $category['question'] ?></textarea>
                            </div>
