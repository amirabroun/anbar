                        ...
                        if ($getCategory ){
                            foreach ($getCategory as $key=> $getcategory){
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $getcategory['address']?></td>
                                    <td nowrap="nowrap">
                                        <a href="/update_about_us_address.php?id=<?php echo $getcategory['id'] ?>" class="btn btn-primary btn-icon btn-shadow-hover font-weight-bold mr-2">
