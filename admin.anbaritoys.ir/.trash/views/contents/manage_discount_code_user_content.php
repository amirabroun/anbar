<div class="content d-flex flex-column flex-column-fluid" id="kt_content" xmlns="http://www.w3.org/1999/html">
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            <?php
            $getCategory = selectcode_userTBL();
            ?>
            <div class="card card-custom gutter-b">
                <div class="card-header" >
                    <h3 class="card-title">کد تخفیف های کاربری</h3>
                </div>
                <div class="card-body">
                        ...
                        if ($getCategory ){
                            foreach ($getCategory as $key=> $getcategory){
                                ...
                                <tr>
                                    ...
                                    <td nowrap="nowrap">
                                        <a href="?action=discount_code_user&code_id=<?php echo $getcategory['id']?>" class="btn btn-danger btn-icon btn-shadow-hover font-weight-bold mr-2">
                                            <i class="fa fa-trash" style='color: white'></i>
                                        </a>
                                        <a href="select_user_code.php?category_id=<?php echo $getcategory['id']?>" class="btn btn-success btn-icon btn-shadow-hover font-weight-bold mr-2" style="width: 40%">
                                            <span class="text-dark font-size-h4">انتخاب کاربران قابل استفاده</span>
                                        </a>
                                        <a href="select_products_user_code.php?category_id=<?php echo $getcategory['id']?>" class="btn btn-warning btn-icon btn-shadow-hover font-weight-bold mr-2" style="width: 40%">
                                          <span class="text-dark font-size-h4">  انتخاب محصولات  غیر قابل اعمال</span>
                                        </a>
                                    </td>
                                </tr>
                        <?php
